# Persistent Capsules with bindings

## About

This example shows how to run and update a persistent WebAssembly capsule using trEVM.
...
* Edit the example's source code in `../../payloads/persistent-with-bindings/`,
  or build an own project in a similar way.

* Rebuild and upload the firmware:

```console
$ ../../precompile_wasm.rs --path ../../payloads/persistent-with-bindings/Cargo.toml -o payload.cwasm --config ../../payloads/.cargo/config.toml
